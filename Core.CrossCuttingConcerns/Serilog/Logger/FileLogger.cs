...
public class FileLogger:LoggerServiceBase
{
    ...
    public FileLogger(IConfiguration configuration)
    {
        ...
        Logger = new LoggerConfiguration().WriteTo.File(
            logFilePath, rollingInterval: RollingInterval.Day,//her gün yeni bir dosya oluştur
            retainedFileCountLimit: null,// eskileri silme
            fileSizeLimitBytes: 5000000,
            outputTemplate: "{Timestamp:yyyy-MM-dd HH:mm:ss.fff zzz} [{Level}] {Message}{NewLine}{Exception}"//ismi
            ).CreateLogger();
    }
}
